...
# Object files
CLIENT_OBJS = $(OBJ_DIR)/serverclient.o $(OBJ_DIR)/recieve_handler.o $(OBJ_DIR)/network_utils.o $(OBJ_DIR)/login_client.o $(OBJ_DIR)/tag_handler.o $(OBJ_DIR)/cache_handler.o $(OBJ_DIR)/disk_space.o $(OBJ_DIR)/semaphore.o
SERVER_OBJS = $(OBJ_DIR)/simpleserver.o $(OBJ_DIR)/request_handler.o $(OBJ_DIR)/network_utils.o $(OBJ_DIR)/login.o $(OBJ_DIR)/tag_handler.o $(OBJ_DIR)/db_handler.o $(OBJ_DIR)/disk_space.o $(OBJ_DIR)/semaphore.o
